...
let badge='Problems-Pro: '+plan.plan; try{const f=[...fs.readdirSync(dir)].filter(x=>x.startsWith('verify-')).pop();const j=JSON.parse(fs.readFileSync(path.join(dir,f),'utf8'));badge+=j.summary?.all_ok?' | VERIFY:PASS':' | VERIFY:BLOCK';}catch{}
