...
function run(cmd){ try { return spawnSync(cmd, { shell:true, stdio:"inherit" }); } catch { return { status:1 }; } }
function readJSON(p){ try { return JSON.parse(readFileSync(p,"utf-8")); } catch { return undefined; } }
...
out.js = readJSON("reports/w5/js-e2e.json") || readJSON("reports/w4/js-e2e.json") || readJSON("reports/js-e2e.json");
